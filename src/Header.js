...
export default function Header({state, setState}) {
  return (
    <div class="header">
      <header class="SearchHeaderContainer">
        <div class="SearchHeaderSearch">
          <span class="SearchHeader_logo">
            <a href="https://news.ycombinator.com">
              <img src="//d1sz9gun5ag95e.cloudfront.net/packs/media/images/logo-hn-search-a822432b.png"></img>
            </a>
          </span>
